...
\subsection*{G}
Sei $G$ gegeben als $G=(V, \varSigma, P, S)$ mit V = {S}, $\varSigma$ = {a,b,c,d} und \\ 
P = $\{$ (S, $\varepsilon$), (S, (aSa)), (S, (bSb)), (S, (cSc)), (S, (dSd)), (S,a), (S,b), (S,c), (S,d) $\}$
...
Jede der Regeln hat die Form $A \rightarrow \alpha $ daher ist $G$ kontextfrei.
