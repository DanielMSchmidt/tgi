...
Zerteilt man ein $z \in L(G_1)$, sodass $z = uvwxy$ gilt. Setzt man nun die Variablen $u := w := x := y := \epsilon$, so ist keine der Bedingungen des Pumping-Lemmas verletzt. Weiterhin gilt
